...
public abstract class Electrodomestico {
	...
	private void comprobarColor(String color) {
		...
		if (color.matches("BLANCO|NEGRO|ROJO|AZUL|GRIS")) {
			...
			this.color = "BLANCO"; // si el color ingresado no esta en las opciones, se asigna BLANCO por
									// defecto
		}
	}

	/**
	 * Metodo crearElectrodomestico(): le pide la informacion al usuario y llena el
	 * electrodomestico, tambien llama los metodos para comprobar el color y el
	...
	/**
	 * M�todo precioFinal(): seg�n el consumo energ�tico y su tama�o,
	 * aumentar� el valor del precio.
	 */
